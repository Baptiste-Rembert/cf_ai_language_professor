/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5cd1a11b27fd308688bd97cd103a6ee2)
// Runtime types generated with workerd@1.20260415.1 2026-04-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ProfessorAgent";
	}
	interface Env {
		AI: Ai;
		PROFESSOR_AGENT: DurableObjectNamespace<import("./src/index").ProfessorAgent>;
		FLASHCARD_WORKFLOW: Workflow<Parameters<import("./src/index").FlashcardWorkflow['run']>[0]['payload']>;
	}
}
